...
def parse(query, pref_manager, tpl_manager, acc_manager):
        ...
        commands = {
            "set": {"browser": pref_manager.update_browser, "mode": pref_manager.update_mode},
            "view": {"question": open_question, "answers": 1, "tpl": lambda: str(tpl_manager), "accounts": lambda: str(acc_manager)},
            "submit": submit,
            "download": download,
            "create": {"tpl": tpl_manager.insert, "accounts": acc_manager.insert, "": create},
            "delete": {"tpl": tpl_manager.delete, "accounts": acc_manager.delete},
            "login": 6,
            "update": {"accounts": 0}
        }
